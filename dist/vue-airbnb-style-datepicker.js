...
var AirbnbStyleDatepicker = { render: function () {
  ...
  created: function created() {
    ...
    window.addEventListener('resize', debounce_1(this.positionDatepicker, 200));
  },
  ...
  computed: {
    ...
    selectedDateText: function selectedDateText() {
      if (this.allDatesSelected) {
        return format_1(this.selectedDate1, 'D MMM') + ' - ' + format_1(this.selectedDate2, 'D MMM');
      }
      if (!this.datesSelected) {
        return this.placeholder;
      }
      return format_1(this.selectedDate1, 'D MMM');
    },
  ...
  methods: {
    ...
    getWeeks: function getWeeks(date) {
      ...
      var skipDaysUntilFirstInMonth = findIndex_1(this.days, function (day) { return day === firstDayName; });
      var weeks = [];
      var week = [];
